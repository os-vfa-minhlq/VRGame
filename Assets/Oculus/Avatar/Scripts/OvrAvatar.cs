...
public class OvrAvatar : MonoBehaviour
{
    ...
    public List<OvrAvatarRenderComponent> ovrRenderParts = new List<OvrAvatarRenderComponent>();
    ...
    {       
        ...
        componentObject.tag = transform.tag;
    ...
    public void TakeDamage(float damage)
    {
        ...
        foreach(var part in ovrRenderParts)
        {
